...
object CookieManager {
    ...
    fun isCookieValid(): Boolean {
        ...
        return cookie != null && expirationTime != null && currentTime < expirationTime
    }

    suspend fun authentication() {
        try {
            val response = SPTransApi.retrofitService.authentication("604a216ace42329aa7581b9c6056a8a3dc2f574a680411928d5570478ca4c707")
